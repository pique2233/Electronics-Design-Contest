...
//    scanf("%lf", &y);
   ...
   __HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_4, pwm_shuiping);  //ˮƽ
   __HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_1, pwm_shuzhi);  //��ֱ
    // ����Ƕ�
...
//#define SCREEN_WIDTH  1920  // ��Ļ��ȣ�������Ϊ��λ��
//#define SCREEN_HEIGHT 1080  // ��Ļ�߶ȣ�������Ϊ��λ��
#define SPEED         10000     // �ƶ��ٶȣ�������Ϊ��λ��
...
//    currentY += (int)(dy * ratio);
    printf("redmove_x:%d\n redmove_y:%d\r\n",redmove_x,redmove_y);
   __HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_4, 750+redmove_x);  //ˮƽ PA11
   __HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_1, 565+redmove_y);  //��ֱ PA8

}

void xie_move(int pointAX,int pointAY,int pointBX,int pointBY,uint16_t time) 
    {
//    int pointAX = 100;      // Ŀ��λ��A��x����
//    int pointAY = 100;      // Ŀ��λ��A��y����
//    int pointBX = 500;      // ���ƶ���B�ĳ�ʼx����
//    int pointBY = 500;      // ���ƶ���B�ĳ�ʼy����
